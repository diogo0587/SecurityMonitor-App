...
class GetActiveAlertsUseCase @Inject constructor(private val repository: SecurityRepository) {
    operator fun invoke(): Flow<List<AlertEntity>> = repository.getActiveAlerts()
}
